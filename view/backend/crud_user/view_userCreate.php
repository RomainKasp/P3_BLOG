		...
		<center><form method="post" action="traitement.php">
			<table class=form-tab>
				<tr>
					...
					<td><input type="text" name="nomNewUti" size="30" maxlength="30" required=required/></td>
				</tr>	
				<tr>
					<td align=right class=form-lib>Mail utilisateur : </td>
					<td><input type="email" name="mailNewUti" size="30" maxlength="30" required=required/></td>
				</tr>		
				<tr>
				...
				<tr>
					<td align=right class=form-lib>Mot de passe : </td>
					<td><input type="password" name="pswNewUti" size="15" maxlength="15" required=required/></td>
				</tr>	
				<tr>
					<td align=right class=form-lib>Confirmation de mot de passe : </td>
